    ...
    "/api/v1/tenants/{id}/logo": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Logo image file (PNG or JPG) */
                        file: unknown;
                    };
                };
            };
    ...
    "/api/v1/exercises/{exerciseId}/diagram": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Diagram image file (PNG or JPG) */
                        file: unknown;
                    };
                };
            };
    ...
    "/api/v1/exercises/{exerciseId}/stimulus-image": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Stimulus image file (PNG or JPG) */
                        file: unknown;
                    };
                };
            };
    ...
    "/api/v1/exercises/{exerciseId}/audio": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Audio file (MP3, WAV, OGG, or M4A) */
                        file: unknown;
                    };
                };
            };
    ...
    "/api/v1/exercises/{exerciseId}/upload-document": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Document file (PDF or DOCX) */
                        file: unknown;
                    };
                };
            };
    ...
    "/api/v1/student/submissions/{id}/photo": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description Photo of handwritten answer */
                        file: unknown;
                        /** @description ID of the question this photo answers */
                        questionId: string;
                    };
                };
            };
    ...
    "/api/v1/users/import/validate": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "multipart/form-data": {
                        /** @description CSV file for import validation */
                        file: unknown;
                    };
                };
            };
                    ...
                    content: {
                        "application/json": {
                            data: {
                                subscription: {
                                    /** @enum {string} */
                                    status: "pilot" | "active" | "past_due" | "canceled" | "grace_period" | "inactive";
                                    /** @enum {string} */
